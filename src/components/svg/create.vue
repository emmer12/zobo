...
export default {
  mounted () {
      gsap.to('.rect1', 2, { opacity:0.3,fill:'#ccc', yoyo:true, repeat:-1 } );
      gsap.to('.rect2', 2, { opacity:0.3,fill:'#ccc', yoyo:true, repeat:-1 } );
      gsap.to('.rect3', 2, { opacity:0.3,fill:'#ccc', yoyo:true, repeat:-1 } );
  },
}
</script>
