<template>
  <div>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#222222" fill-opacity="1" d="M0,96L12.6,112C25.3,128,51,160,76,154.7C101.1,149,126,107,152,122.7C176.8,139,202,213,227,240C252.6,267,278,245,303,202.7C328.4,160,354,96,379,96C404.2,96,429,160,455,154.7C480,149,505,75,531,80C555.8,85,581,171,606,213.3C631.6,256,657,256,682,266.7C707.4,277,733,299,758,277.3C783.2,256,808,192,834,186.7C858.9,181,884,235,909,229.3C934.7,224,960,160,985,144C1010.5,128,1036,160,1061,181.3C1086.3,203,1112,213,1137,192C1162.1,171,1187,117,1213,128C1237.9,139,1263,213,1288,208C1313.7,203,1339,117,1364,106.7C1389.5,96,1415,160,1427,192L1440,224L1440,320L1427.4,320C1414.7,320,1389,320,1364,320C1338.9,320,1314,320,1288,320C1263.2,320,1238,320,1213,320C1187.4,320,1162,320,1137,320C1111.6,320,1086,320,1061,320C1035.8,320,1011,320,985,320C960,320,935,320,909,320C884.2,320,859,320,834,320C808.4,320,783,320,758,320C732.6,320,707,320,682,320C656.8,320,632,320,606,320C581.1,320,556,320,531,320C505.3,320,480,320,455,320C429.5,320,404,320,379,320C353.7,320,328,320,303,320C277.9,320,253,320,227,320C202.1,320,177,320,152,320C126.3,320,101,320,76,320C50.5,320,25,320,13,320L0,320Z"></path></svg>
       <div class="footer">
           <v-container grid-list-md>
              ...
              <div class="mt-5">
                 <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel iste accusantium nesciunt, laboriosam dolores possimus suscipit laborum iusto! Explicabo, unde incidunt?</p>
              </div>

              </v-flex>

              <v-flex md4 xs12>
                 <h4 class="mb-2 primary--text">important Links</h4>
                <div>
                   <router-link to="/about" tag="div" style="cursor:pointer">About</router-link>
                   <router-link to="/faq" tag="div" style="cursor:pointer">FAQ</router-link>
                 </div>
              </v-flex>
