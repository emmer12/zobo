<template>
  <div style="z-index:1;position:relative" v-if="user.confirmed">
    <!-- <pin-view></pin-view> -->
    <div class="dashboard">
  ...
  <div v-else class="d-flex justify-center align-content-center">
     <div class="email-confirm">
        ...
        <h1>You've go mail</h1>
        <p>We have sent an email to {{user.email}} wih the link for acivaing your account and proving you are human</p>
